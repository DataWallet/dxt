...
if (typeof erc20contract_address == "undefined") {
  var erc20contract_address = "0x8dB54ca569D3019A2ba126D03C37c44b5eF81EF6";
...
function try2sell() {
  ...
  if ($("#skoko").val() < 1) {
    ...
    if (tosell = prompt('How many DXT you want to sell?', $("#skoko").val())) {
...
$("#savethis").val("Warning! Withdraw all amounts of DXT to your own ethereum wallet! Save this information to your local device! \r\nopenkey:" + openkey + "\r\nprivkey:" + privkey);
